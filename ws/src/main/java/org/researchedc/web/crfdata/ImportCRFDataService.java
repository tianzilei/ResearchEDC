package org.researchedc.web.crfdata;
...
public class ImportCRFDataService {
                                ...
                                for (int i = 1; i <= groupMaxOrdinals.get(itemGroupDataBean.getItemGroupOID()); i++) {
                                    for (ItemBean itemBean : blankCheckItems) {
                                        ...
                                        if (blankCheck.get(newKey) == null) {
                                            ...
                                            ItemDataBean itemDataCheck = itemDataDao.findByItemIdAndEventCRFIdAndOrdinal(itemBean.getId(),
    ...
    private void attachValidator(DisplayItemBean displayItemBean, ImportHelper importHelper, DiscrepancyValidator discValidator, HashMap<String, String> hardv,
        ...
        org.researchedc.bean.core.ResponseType rt = displayItemBean.getMetadata().getResponseSet().getResponseType();
