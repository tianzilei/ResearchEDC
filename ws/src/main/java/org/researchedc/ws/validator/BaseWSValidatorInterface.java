...
public interface BaseWSValidatorInterface {
	...
	public abstract StudyBean verifyStudy( IStudyDAO dao, String study_id, Status[] included_status,  Errors errors);
	public abstract StudyBean verifyStudyByOID( IStudyDAO dao, String study_id, Status[] included_status,	 Errors errors);
	public abstract StudyBean verifySite( IStudyDAO dao, String study_id,  String site_id,Status[] included_status,  Errors errors);
