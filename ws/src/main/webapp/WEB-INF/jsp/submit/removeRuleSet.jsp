...
<tr id="sidebar_Instructions_open" style="display: all">
        ...
        <div class="sidebar_tab_content">
            <fmt:message key="remove_rule_assignment_1" bundle="${restext}"/>&nbsp;<c:out value="${study.name}"/>.&nbsp;<fmt:message key="remove_rule_assignment_2" bundle="${restext}"/>
        </div>
        </td>
    </tr>
...
<jsp:useBean scope='request' id='ruleSet' class='org.researchedc.domain.rule.RuleSetBean'/>
