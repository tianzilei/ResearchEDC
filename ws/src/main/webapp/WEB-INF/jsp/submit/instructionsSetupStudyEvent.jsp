		...
		<!-- Workflow items -->
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
							...
							<span class="title_submit">
				              <c:choose>
					          <c:when test='${currStep == "enroll"}'>
						       <b><fmt:message key="add_new_subject" bundle="${resworkflow}"/></b>
					          </c:when>
					          <c:otherwise>
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
					       ...
					       <c:choose>
					           <c:when test='${currStep == "createEvent"}'>
						          <b><fmt:message key="add2" bundle="${resword}"/><br> <fmt:message key="study" bundle="${resword}"/><br> <fmt:message key="event" bundle="${resword}"/></b>
					         </c:when>
					         <c:otherwise>
						       <fmt:message key="add2" bundle="${resword}"/><br> <fmt:message key="study" bundle="${resword}"/><br> <fmt:message key="event" bundle="${resword}"/>
					           </c:otherwise>
				              </c:choose>
