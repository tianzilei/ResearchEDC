...
<table width="600" border="0" cellpadding="0" cellspacing="0" id="Table0" style="display: all">
        ...
        <tr>
            ...
            <td class="table_tools" nowrap>
                ...
                <c:if test="${! (suppressAddSubject eq 'true')}">
                    <b>
                        ...
                        <a href="javascript:HideGroups(0,<c:out value="${groupCount+4}"/>,10);">
                            <c:choose>
                                <c:when test="${table.sortingColumnInd >= 1 && table.sortingColumnInd <= groupCount+4}">
                                    <div id="HideGroups" style="display: all"><fmt:message key="hide" bundle="${resword}"/></div>
            ...
            <td class="table_tools" nowrap>
                ...
                <c:if test="${! (suppressAddSubject eq 'true')}">
                    ...
                    <b>
                        <a href="javascript:showSubjectRow('HideGroups', <c:out value="${groupCount+2}"/>, 'AddSubjectRow1','AddSubjectRow2');">
    ...
    <c:forEach var="column" items="${table.columns}">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <c:choose>
                        <c:when test="${i>=1 && i<=4 }">
                            <c:choose>
                                <c:when test="${table.sortingColumnInd >=1 && table.sortingColumnInd <=4}">
        ...
        <c:if test="${groupCount>0}">
            <c:choose>
                ...
                <c:when test="${i>0 && i < 5 + groupCount}">
                    <c:choose>
        ...
        <c:if test="${column.showLink}"><a href="<c:out value="${orderByQuery}"/>"></c:if><c:out value="${column.name}" /><c:if test="${columnLen == (i + 1)}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</c:if><c:if test="${column.showLink}"></a></c:if>
