...
<a href="javascript:openDocWindow('PrintDataEntry?ecId=<c:out value="${toc.eventCRF.id}"/>')"
					...
					<a href="javascript:openDocWindow('PrintDataEntry?ecId=<c:out value="${toc.eventCRF.id}"/>')"><fmt:message key="print_entire_CRF" bundle="${resword}"/></a>
