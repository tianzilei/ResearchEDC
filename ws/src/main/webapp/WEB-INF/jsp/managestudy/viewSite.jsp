...
<jsp:useBean scope='request' id='siteToView' class='org.researchedc.bean.managestudy.StudyBean'/>
...
<br>
	...
	<div class="table_title_Manage"><fmt:message key="view_site_event_definitions" bundle="${resword}"/></div>
