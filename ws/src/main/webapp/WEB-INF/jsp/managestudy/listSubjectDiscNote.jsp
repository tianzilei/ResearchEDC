...
<div class="dnKey"><strong><fmt:message key="Filter_by_status" bundle="${resword}"/>
    ...
    <c:if test="${filterSummary != null && ! (empty filterSummary['status'])}">
        ...
        <a href="ListDiscNotesSubjectServlet?module=${module}&type=${param.type}"><fmt:message key="Clear_status_filter" bundle="${resword}"/></a>
    </c:if>
</div>
...
<div class="dnKey"><strong><fmt:message key="Filter_by_note_type" bundle="${resword}"/>
    ...
    <a href="ListDiscNotesSubjectServlet?module=${module}&defId=${eventDefinitionId}&type=2&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.type == 2}">style="color:green"</c:if>><fmt:message key="Annotation" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    ...
    <a href="ListDiscNotesSubjectServlet?module=${module}&defId=${eventDefinitionId}&type=3&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.type == 3}">style="color:green"</c:if>><fmt:message key="query" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    <a href="ListDiscNotesSubjectServlet?module=${module}&defId=${eventDefinitionId}&type=4&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.type == 4}">style="color:green"</c:if>><fmt:message key="reason_for_change" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    <br />
    <c:if test="${filterSummary != null  && ! (empty filterSummary['type'])}">
        ...
        <a href="ListDiscNotesSubjectServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&type=50"><fmt:message key="Clear_type_filter" bundle="${resword}"/></a>
    </c:if>
</div>
