 ...
 <tbody>
   <tr>
	...
	<!-- Thread title -->
		...
		<div style="float: right; padding-left: 30px;"><b>Last updated:</b> <fmt:formatDate value="${singleNote.createdDate}" pattern="${dteFormat}"/> by <c:out value="${singleNote.owner.name}"/></div>
		</td>
	   </tr>
	   <tr class="aka_stripes">
