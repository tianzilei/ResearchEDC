...
| JSP 页面数 | 417 → **192 剩余** (~225 已替换, 54%) | 🟡 **6 阶段绞杀完成, 余量通过 LegacyFrame** |
| React SPA 页面 | **28 页面, 30+ 路由** | ✅ **覆盖管理/研究/受试者/录入/导出/配置** |
| Legacy 桥接 API | **5 个控制器, 9 个 DTO** | ✅ **差异备注/规则集/CRF管理/数据集/分组** |
...
| 测试覆盖率 | < 1% | 🔴 需增量门禁 |
| 前端测试 | 0 测试 (28 页面, 13 组件) | 🔴 Vitest 框架已就绪 |
...
- [x] **至少 20% 的 JSP 页面有 React 替代** — **54% (225/417) 已完成**
