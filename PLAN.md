...
| Java 测试覆盖 | **146 tests** (study 21, randomization 25, export 11, subject 15, event 12, datacapture 9, identity 11, legacy-gateway 41, modulith 1) | 🟢 10 个模块已达基线 |
| 陈旧依赖数 | 8+ (JMesa, Castor, Rome 等) | 🟡 随 JSP/SOAP 绞杀自然退役 |
| 旧版 Spring Security OAuth2 | `spring-security-oauth2` 2.0.x | ✅ 已移除 (死依赖) |
| 测试覆盖率 | < 1% | 🔴 需增量门禁 |
| 前端测试 | **7 tests** (FormField 组件) | 🟡 Vitest 框架已就绪 |
...
- [x] **Modulith 模块测试覆盖确认**: 146 tests, 0 failures (JDK 21)
