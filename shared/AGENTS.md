...
├── domain/       # Hibernate/domain entities — 32 Java files
...
| **Domain Entities** | 32 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 19 Java files); former duplicate admin/managestudy, technical admin, retired crfdata, retired rule, DN/subjectgroup/discrepancy-note map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (19 Java files)
