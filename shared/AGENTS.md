...
├── domain/       # Hibernate/domain entities — 66 Java files
...
| **Domain Entities** | 66 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 45 Java files); former duplicate admin/managestudy, technical admin, retired rule, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (45 Java files)
