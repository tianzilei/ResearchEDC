...
├── domain/       # Hibernate/domain entities — 56 Java files
...
| **Domain Entities** | 56 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 35 Java files); former duplicate admin/managestudy, technical admin, retired rule, DN map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (35 Java files)
