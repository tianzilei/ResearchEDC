...
├── domain/       # Hibernate/domain entities — 30 Java files
...
| **Domain Entities** | 30 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 17 Java files); former duplicate admin/managestudy, technical admin, retired crfdata, retired rule, DN/subjectgroup/discrepancy-note/study-user-role map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (17 Java files)
