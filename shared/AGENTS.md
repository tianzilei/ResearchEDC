...
├── domain/       # Hibernate/domain entities — 46 Java files
...
| **Domain Entities** | 46 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 25 Java files); former duplicate admin/managestudy, technical admin, retired rule, DN/subjectgroup map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (25 Java files)
