...
├── domain/       # Hibernate/domain entities — 54 Java files
...
| **Domain Entities** | 54 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 33 Java files); former duplicate admin/managestudy, technical admin, retired rule, DN map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (33 Java files)
