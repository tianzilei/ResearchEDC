...
├── domain/       # Hibernate/domain entities — 49 Java files
...
| **Domain Entities** | 49 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 28 Java files); former duplicate admin/managestudy, technical admin, retired rule, DN/subjectgroup map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (28 Java files)
