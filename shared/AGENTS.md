...
├── domain/       # Hibernate/domain entities — 44 Java files
...
| **Domain Entities** | 44 | Hibernate `@Entity` classes mapping to database tables (`datamap/` has 23 Java files); former duplicate admin/managestudy, technical admin, retired rule, DN/subjectgroup map, and unused datamap mappings have been removed |
...
- **Entities:** Hibernate `@Entity` classes in `domain/datamap/` (23 Java files)
