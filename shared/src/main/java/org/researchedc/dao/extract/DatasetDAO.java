 ...
 */
package org.researchedc.dao.extract;
...
public class DatasetDAO extends AuditableEntityDAO implements org.researchedc.dao.spi.DatasetDao {
    ...
    public EntityBean create(EntityBean eb) {
        ...
        variables.put(Integer.valueOf(7), Integer.valueOf(db.getNumRuns()));
        variables.put(Integer.valueOf(8), Boolean.valueOf(db.isShowEventLocation()));
        variables.put(Integer.valueOf(9), Boolean.valueOf(db.isShowEventStart()));
        variables.put(Integer.valueOf(10), Boolean.valueOf(db.isShowEventEnd()));
        variables.put(Integer.valueOf(11), Boolean.valueOf(db.isShowSubjectDob()));
        variables.put(Integer.valueOf(12), Boolean.valueOf(db.isShowSubjectGender()));
        variables.put(Integer.valueOf(13), Boolean.valueOf(db.isShowEventStatus()));
        variables.put(Integer.valueOf(14), Boolean.valueOf(db.isShowSubjectStatus()));
        variables.put(Integer.valueOf(15), Boolean.valueOf(db.isShowSubjectUniqueIdentifier()));
        variables.put(Integer.valueOf(16), Boolean.valueOf(db.isShowSubjectAgeAtEvent()));
        variables.put(Integer.valueOf(17), Boolean.valueOf(db.isShowCRFstatus()));
        variables.put(Integer.valueOf(18), Boolean.valueOf(db.isShowCRFversion()));
        variables.put(Integer.valueOf(19), Boolean.valueOf(db.isShowCRFinterviewerName()));
        variables.put(Integer.valueOf(20), Boolean.valueOf(db.isShowCRFinterviewerDate()));
        variables.put(Integer.valueOf(21), Boolean.valueOf(db.isShowSubjectGroupInformation()));
        // variables.put(Integer.valueOf(22), new
        // Boolean(db.isShowDiscrepancyInformation()));
        variables.put(Integer.valueOf(22), Boolean.valueOf(false));
    ...
    public EntityBean updateAll(EntityBean eb) {
        ...
        variables.put(Integer.valueOf(10), db.getDateStart());
        variables.put(Integer.valueOf(11), db.getDateEnd());
        variables.put(Integer.valueOf(12), Boolean.valueOf(db.isShowEventLocation()));
        variables.put(Integer.valueOf(13), Boolean.valueOf(db.isShowEventStart()));
        variables.put(Integer.valueOf(14), Boolean.valueOf(db.isShowEventEnd()));
        variables.put(Integer.valueOf(15), Boolean.valueOf(db.isShowSubjectDob()));
        variables.put(Integer.valueOf(16), Boolean.valueOf(db.isShowSubjectGender()));
        variables.put(Integer.valueOf(17), Boolean.valueOf(db.isShowEventStatus()));
        variables.put(Integer.valueOf(18), Boolean.valueOf(db.isShowSubjectStatus()));
        variables.put(Integer.valueOf(19), Boolean.valueOf(db.isShowSubjectUniqueIdentifier()));
        variables.put(Integer.valueOf(20), Boolean.valueOf(db.isShowSubjectAgeAtEvent()));
        variables.put(Integer.valueOf(21), Boolean.valueOf(db.isShowCRFstatus()));
        variables.put(Integer.valueOf(22), Boolean.valueOf(db.isShowCRFversion()));
        variables.put(Integer.valueOf(23), Boolean.valueOf(db.isShowCRFinterviewerName()));
        variables.put(Integer.valueOf(24), Boolean.valueOf(db.isShowCRFinterviewerDate()));
        variables.put(Integer.valueOf(25), Boolean.valueOf(db.isShowSubjectGroupInformation()));
        variables.put(Integer.valueOf(26), Boolean.valueOf(false));
        ...
        variables.put(Integer.valueOf(31), Boolean.valueOf(db.isShowSubjectSecondaryId()));
