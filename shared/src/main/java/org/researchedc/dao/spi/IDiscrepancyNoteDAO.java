...
public interface IDiscrepancyNoteDAO {
    ...
    ArrayList<DiscrepancyNoteBean> findAllParentItemNotesByEventCRFWithConstraints(int eventCRFId, StringBuffer constraints);    Integer getViewNotesCountWithFilter(String filter, StudyBean currentStudy);    ArrayList<DiscrepancyNoteBean> findAllDiscrepancyNotesDataByStudy(StudyBean currentStudy);    Collection findAllByEntityAndColumn(String entityName, int entityId, String column);
