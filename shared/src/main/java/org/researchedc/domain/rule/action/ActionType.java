...
import org.researchedc.domain.enumsupport.CodedEnum;
...
public enum ActionType implements CodedEnum {
    ...
    FILE_DISCREPANCY_NOTE(1, "DiscrepancyNoteAction"), SHOW(3, "ShowAction"), INSERT(4, "InsertAction"), HIDE(5, "HideAction"),EVENT(6,"EventAction"),RANDOMIZE(8,"RandomizeAction");
