...
import org.researchedc.domain.rule.RuleSetRuleBean.RuleSetRuleBeanImportStatus;
import org.researchedc.domain.rule.RulesPostImportContainer;
...
import org.researchedc.logic.rulerunner.BeanPropertyRuleRunner;
import org.researchedc.logic.rulerunner.CrfBulkRuleRunner;
import org.researchedc.logic.rulerunner.DataEntryRuleRunner;
import org.researchedc.logic.rulerunner.ExecutionMode;
import org.researchedc.logic.rulerunner.ImportDataRuleRunner;
...
@Transactional
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#saveImport(org.researchedc.domain.rule.RulesPostImportContainer)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#updateRuleSet(org.researchedc.domain.rule.RuleSetBean,
     * org.researchedc.bean.login.UserAccountBean, org.researchedc.domain.Status)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#loadRuleSetRuleWithPersistentRules(org.researchedc.domain.rule.RuleSetBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#replaceRuleSet(org.researchedc.domain.rule.RuleSetBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#runRulesInBulk(java.lang.String, java.lang.Boolean,
     * org.researchedc.bean.managestudy.StudyBean, org.researchedc.bean.login.UserAccountBean)
     */
    public HashMap<RuleBulkExecuteContainer, HashMap<RuleBulkExecuteContainerTwo, Set<String>>> runRulesInBulk(String crfId, ExecutionMode executionMode,
        ...
        configureRuleRunner(ruleRunner);
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#runRulesInBulk(java.lang.String, java.lang.String, java.lang.Boolean,
     * org.researchedc.bean.managestudy.StudyBean, org.researchedc.bean.login.UserAccountBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#runRulesInBulk(java.util.List, java.lang.Boolean,
     * org.researchedc.bean.managestudy.StudyBean, org.researchedc.bean.login.UserAccountBean)
     */
    public List<RuleSetBasedViewContainer> runRulesInBulk(List<RuleSetBean> ruleSets, Boolean dryRun, StudyBean currentStudy, UserAccountBean ub , boolean jobTrigger) {
        ...
        ruleSets = filterRuleSetsByGroupOrdinal(ruleSets);
        RuleSetBulkRuleRunner ruleRunner = new RuleSetBulkRuleRunner(dataSource, requestURLMinusServletPath, contextPath);
        configureRuleRunner(ruleRunner);
        dynamicsMetadataService.setExpressionService(getExpressionService());
        ruleRunner.setDynamicsMetadataService(dynamicsMetadataService);
        ruleRunner.setRuleActionRunLogDao(ruleActionRunLogDao);
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#runRulesInDataEntry(java.util.List, java.lang.Boolean,
     * org.researchedc.bean.managestudy.StudyBean, org.researchedc.bean.login.UserAccountBean, java.util.HashMap)
     */
    public MessageContainer runRulesInDataEntry(List<RuleSetBean> ruleSets, Boolean dryRun, StudyBean currentStudy, UserAccountBean ub,
        ...
        DataEntryRuleRunner ruleRunner = new DataEntryRuleRunner(dataSource, requestURLMinusServletPath, contextPath, ecb);
        configureRuleRunner(ruleRunner);
        dynamicsMetadataService.setExpressionService(getExpressionService());
        ruleRunner.setDynamicsMetadataService(dynamicsMetadataService);
        ruleRunner.setRuleActionRunLogDao(ruleActionRunLogDao);
     ...
     * (non-Javadoc)
     * @see
     * org.researchedc.service.rule.RuleSetServiceInterface#getRuleSetsByCrfStudyAndStudyEventDefinition(org.researchedc.bean.managestudy.StudyBean,
     * org.researchedc.bean.managestudy.StudyEventDefinitionBean, org.researchedc.bean.submit.CRFVersionBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#getRuleSetsByStudy(org.researchedc.bean.managestudy.StudyBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#getRuleSetById(org.researchedc.bean.managestudy.StudyBean, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#getRuleSetById(org.researchedc.bean.managestudy.StudyBean, java.lang.String,
     * org.researchedc.domain.rule.RuleBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#getRuleSetsByCrfAndStudy(org.researchedc.bean.admin.CRFBean,
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#filterByStatusEqualsAvailableOnlyRuleSetRules(java.util.List)
     */
    public List<RuleSetBean> filterByStatusEqualsAvailableOnlyRuleSetRules(List<RuleSetBean> ruleSets) {
        for (RuleSetBean ruleSet : ruleSets) {
            for (Iterator<RuleSetRuleBean> i = ruleSet.getRuleSetRules().iterator(); i.hasNext();)
                if (i.next().getStatus() != org.researchedc.domain.Status.AVAILABLE) {
                    i.remove();
                }
        }
        return ruleSets;
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#filterByStatusEqualsAvailable(java.util.List)
     */
    ...
    public List<RuleSetBean> filterByStatusEqualsAvailable(List<RuleSetBean> ruleSets) {
        for (Iterator<RuleSetBean> j = ruleSets.iterator(); j.hasNext();) {
            ...
            if (ruleSet.getStatus() == org.researchedc.domain.Status.AVAILABLE) {
                for (Iterator<RuleSetRuleBean> i = ruleSet.getRuleSetRules().iterator(); i.hasNext();)
                    if (i.next().getStatus() != org.researchedc.domain.Status.AVAILABLE) {
                        i.remove();
                    }
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#filterByRules(org.researchedc.domain.rule.RuleSetBean, java.lang.Integer)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#filterRuleSetsByStudyEventOrdinal(java.util.List,
     * org.researchedc.bean.managestudy.StudyEventBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#solidifyGroupOrdinalsUsingFormProperties(java.util.List, java.util.HashMap)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#filterRuleSetsBySectionAndGroupOrdinal(java.util.List, java.util.HashMap)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#filterRuleSetsByGroupOrdinal(java.util.List)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#getGroupOrdinalPlusItemOids(java.util.List)
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.researchedc.service.rule.RuleSetServiceInterface#replaceCrfOidInTargetExpression(org.researchedc.domain.rule.RuleSetBean,
     * java.lang.String)
     */
    ...
    public void runRulesInBeanProperty(List<RuleSetBean> ruleSets,Integer userId,StudyEventChangeDetails changeDetails) {	
    	    BeanPropertyRuleRunner ruleRunner = new BeanPropertyRuleRunner(dataSource, requestURLMinusServletPath, contextPath);
            configureRuleRunner(ruleRunner);
    		...
    		ruleRunner.runRules(ruleSets,dataSource,beanPropertyService, getStudyEventDomainDao(), getStudyEventDefDomainDao(),changeDetails,userId);
}
    ...
    public void runIndividualRulesInBeanProperty(List<RuleSetBean> ruleSets,Integer userId,StudyEventChangeDetails changeDetails , Integer studyEventOrdinal) {	
	    ...
	    BeanPropertyRuleRunner ruleRunner = new BeanPropertyRuleRunner(dataSource, requestURLMinusServletPath, contextPath);
        configureRuleRunner(ruleRunner);
 		ruleRunner.runRules(ruleSetBeans,dataSource,beanPropertyService, getStudyEventDomainDao(), getStudyEventDefDomainDao(),changeDetails,userId);
}
