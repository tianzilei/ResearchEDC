...
public class OpenClinicaMailSender {
    ...
    public String sendEmail(String to, String subject, String body, boolean html) { return ""; }
    public String sendEmail(String to, String subject, String message, String a, Object b) { return ""; }
}
