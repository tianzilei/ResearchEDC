...
public class DisplayItemBean implements Comparable {
    ...
    public void setMetadata(ItemFormMetadataBean metadata) {
        ...
        if (rt.equals(org.researchedc.bean.core.ResponseType.CHECKBOX) || rt.equals(org.researchedc.bean.core.ResponseType.RADIO)
            || rt.equals(org.researchedc.bean.core.ResponseType.SELECT) || rt.equals(org.researchedc.bean.core.ResponseType.SELECTMULTI)) {
