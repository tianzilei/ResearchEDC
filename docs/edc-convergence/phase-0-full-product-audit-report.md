...
4. Missing artifact behavior fixed in Phase 1 slice 2; export download now has a role gate. Remaining: verify export download ownership/study-scope checks explicitly.
