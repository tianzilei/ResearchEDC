...
3. Minimum role authorization rules added in Phase 1 slice 2 for core mutating endpoints plus data/artifact read surfaces. Export job lifecycle scoping now covers create/list/get/cancel/retry/download. Remaining: per-study resource scoping for non-export modules.
