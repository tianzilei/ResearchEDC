...
3. Minimum role authorization rules added in Phase 1 slice 2 for core mutating endpoints plus data/artifact read surfaces. Export job lifecycle scoping now covers create/list/get/cancel/retry/download, and import job lifecycle scoping covers create/upload/list/get/preview/validate/commit. Remaining: per-study resource scoping for other study-bound modules.
