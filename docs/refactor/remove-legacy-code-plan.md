...
| **Import/Export Compatibility** | 10 artifacts | Initial SPA/API upload → validate → commit path is hardened; remaining blockers are rule XML import and broader ODM/OpenRosa/export contract coverage; legacy import job scheduling is retired in the current tree |
