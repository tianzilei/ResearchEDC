...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = (
        "postgresql+psycopg://openclinica:openclinica@localhost:5432/openclinica_questionnaire"
    )
    ...
    keycloak_realm: str = "openclinica"
    keycloak_client_id: str = "openclinica-frontend"
