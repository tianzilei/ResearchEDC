package org.akaza.openclinica.module.subject.application;
...
import org.akaza.openclinica.module.subject.domain.SubjectPolicy;
...
import org.akaza.openclinica.module.subject.event.SubjectEnrolledEvent;
...
public class SubjectApplicationService {
    ...
    public SubjectDTO createSubject(CreateSubjectCommand command, Integer ownerId) {
        ...
        return subjectService.createSubject(request, ownerId);
    }
