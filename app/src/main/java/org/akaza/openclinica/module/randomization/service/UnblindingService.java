package org.akaza.openclinica.module.randomization.service;

import java.time.LocalDateTime;
import java.util.List;
import java.util.NoSuchElementException;
import org.akaza.openclinica.module.randomization.dto.UnblindingRequestDTO;
...
import org.akaza.openclinica.module.randomization.repository.RandomizationAssignmentRepository;
import org.akaza.openclinica.module.randomization.repository.RandomizationAuditLogRepository;
import org.akaza.openclinica.module.randomization.repository.UnblindingRequestRepository;
    ...
    public UnblindingRequestDTO reviewUnblinding(Long requestId, UnblindingStatus decision,
        ...
        if (decision == UnblindingStatus.APPROVED) {
            ...
            assignment.setStatus(
                    org.akaza.openclinica.module.randomization.enums.AssignmentStatus.UNBLINDED);
