...
<jsp:useBean scope="request" id="displayItem" class="org.researchedc.bean.submit.DisplayItemBean" />
<jsp:useBean scope="request" id="responseOptionBean" class="org.researchedc.bean.submit.ResponseOptionBean" />
