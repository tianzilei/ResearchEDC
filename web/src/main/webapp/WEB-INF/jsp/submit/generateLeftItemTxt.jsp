...
<%@ page import="org.researchedc.logic.score.*, java.util.HashMap, java.util.ArrayList, org.researchedc.bean.submit.ResponseOptionBean, org.researchedc.bean.submit.ItemBean" %>
