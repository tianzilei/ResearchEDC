...
<fmt:setBundle basename="org.researchedc.i18n.audit_events" var="resaudit"/>
...
<jsp:useBean scope='session' id='userRole' class='org.researchedc.bean.login.StudyUserRoleBean' />
<jsp:useBean scope="request" id="currRow" class="org.researchedc.web.bean.AuditEventRow" />
