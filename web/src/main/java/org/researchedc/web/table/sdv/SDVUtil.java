...
import org.researchedc.controller.helper.table.SDVToolbar;
...
public class SDVUtil {
     ...
     * "org.researchedc.i18n.words",LocaleResolver.getLocale(request));
     * 
    ...
    public String renderEventCRFTableWithLimit(HttpServletRequest request, int studyId, String pathPrefix) {
        ...
        HtmlTable table = (HtmlTable) tableFacade.getTable();
        // i18n caption; TODO: convert to Spring messages
        ResourceBundle resword = ResourceBundle.getBundle("org.researchedc.i18n.words", LocaleResolver.getLocale(request));
    ...
    public Collection<SubjectSDVContainer> getSubjectRows(List<EventCRFBean> eventCRFBeans, HttpServletRequest request) {
        ...
        IStudySubjectDAO studySubjectDAO = new StudySubjectDAO(dataSource);
        ISubjectDAO subjectDAO = new SubjectDAO(dataSource);
        IStudyDAO studyDAO = new StudyDAO(dataSource);
        IStudyEventDAO studyEventDAO = new StudyEventDAO(dataSource);
    ...
    public void getEventNamesForEventCRFs(List<EventCRFBean> eventCRFBeans) {
        ...
        IStudyEventDAO studyEventDAO = new StudyEventDAO(dataSource);
        IStudyEventDefinitionDAO studyEventDefinitionDAO = new StudyEventDefinitionDAO(dataSource);
    ...
    public void prepareSDVSelectElements(HttpServletRequest request, StudyBean studyBean) {
        ...
        for (org.researchedc.domain.Status stat : org.researchedc.domain.Status.values()) {
