...
import org.researchedc.web.table.sdv.SubjectIdSDVFactory;
...
public class SDVController {
    ...
    */
    private String renderSubjectsTable(List<EventCRFBean> eventCRFBeans, int studySubjectId, HttpServletRequest request) {
        ...
        ResourceBundle resourceBundle = ResourceBundle.getBundle("org.researchedc.i18n.words", LocaleResolver.getLocale(request));
