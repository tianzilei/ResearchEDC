...
import org.researchedc.bean.login.ErrorObject;
import org.researchedc.bean.login.ResponseSuccessEventDefDTO;
import org.researchedc.bean.login.ResponseSuccessSiteDTO;
import org.researchedc.bean.login.ResponseSuccessStudyDTO;
import org.researchedc.bean.login.SiteDTO;
import org.researchedc.bean.login.StudyDTO;
...
public class StudyController {
	...
	public Boolean verifyProtocolTypeExist(String protocolType) {
		ResourceBundle resadmin = org.researchedc.i18n.util.ResourceBundleProvider.getAdminBundle();
	...
	public StudyEventDefinitionBean buildEventDefBean(String name, String description, String category, String type, String repeating, UserAccountBean owner, StudyBean parentStudy) {
        ...
        seddao = this.studyEventDefinitionDao;
	...
	public void validateUniqueProId(HttpServletRequest request, HashMap errors) {
		...
		for (StudyBean thisBean : allStudies) {
			if (request.getAttribute("uniqueProId") != null && request.getAttribute("uniqueProId").equals(thisBean.getIdentifier())) {
				ResourceBundle resexception = org.researchedc.i18n.util.ResourceBundleProvider.getExceptionsBundle();
	...
	public StudyBean buildStudyBean(String uniqueProtocolId, String name, String briefSummary, String principalInvestigator, String sponsor, int expectedTotalEnrollment, String protocolType,
		...
		ResourceBundle resword = org.researchedc.i18n.util.ResourceBundleProvider.getWordsBundle();
