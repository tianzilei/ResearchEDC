...
import org.researchedc.bean.submit.SCDItemDisplayInfo;
...
import org.researchedc.logic.score.ScoreCalculator;
...
import org.researchedc.service.crfdata.front.InstantOnChangeFrontStrParcel;
import org.researchedc.service.rule.RuleSetServiceInterface;
import org.researchedc.view.Page;
import org.researchedc.view.form.DataEntryInputGenerator;
...
public abstract class DataEntryServlet extends CoreSecureController {
    ...
    /*
     * locale = LocaleResolver.getLocale(request); //< resmessage = ResourceBundle.getBundle("org.researchedc.i18n.page_messages" ,locale); //< restext =
     * ResourceBundle.getBundle("org.researchedc.i18n.notes",locale); //< resexception =ResourceBundle.getBundle("org.researchedc.i18n.exceptions"
     * ,locale);
     */
          ...
          //JN: This is the list that contains all the scd-shown items.
            ...
            if (!errors.isEmpty()) {
                ...
                */
                ...
                if (ecdao == null) {
                    ecdao = (EventCRFDao) this.eventCrfDao;
                }
...
//                                }
    ...
    protected DisplayItemBean loadFormValue(DisplayItemBean dib, HttpServletRequest request) {
        ...
        if (rt.equals(org.researchedc.bean.core.ResponseType.CHECKBOX) || rt.equals(org.researchedc.bean.core.ResponseType.SELECTMULTI)
                || rt.equals(org.researchedc.bean.core.ResponseType.SELECT)) {
     ...
     */
    protected boolean writeToDB(DisplayItemBean dib, IItemDataDAO iddao, int ordinal, HttpServletRequest request) {
        ItemDataBean idb = dib.getData();
        EventCRFBean ecb = (EventCRFBean)request.getAttribute(INPUT_EVENT_CRF);
    ...
    protected boolean writeToDB(ItemDataBean itemData, DisplayItemBean dib, IItemDataDAO iddao, int ordinal, HttpServletRequest request) {
...
//                }
    ...
    protected String addAttachedFilePath(DisplayItemBean dib, String attachedFilePath) {
        ...
        if (rt.equals(org.researchedc.bean.core.ResponseType.FILE) && itemDataValue.length() > 0) {
...
//                displayItemBean.loadDBValue();
    ...
    private List<DisplayItemBean> processInputForGroupItem(FormProcessor fp, List<DisplayItemBean> dibs, int i, DisplayItemGroupBean digb, boolean isAuto) {
        for (int j = 0; j < dibs.size(); j++) {
            ...
            String inputName = "";
            org.researchedc.bean.core.ResponseType rt = displayItem.getMetadata().getResponseSet().getResponseType();
            if (rt.equals(org.researchedc.bean.core.ResponseType.CHECKBOX) || rt.equals(org.researchedc.bean.core.ResponseType.SELECTMULTI)) {
                ...
                // necessary here
                if (rt.equals(org.researchedc.bean.core.ResponseType.SELECT)) {
    ...
    protected boolean isChanged(DisplayItemBean dib, HashMap<String, ItemDataBean> oldItemdata, String attachedFilePath) {
        ...
        org.researchedc.bean.core.ResponseType rt =dib.getMetadata().getResponseSet().getResponseType();
        if ( rt.equals(org.researchedc.bean.core.ResponseType.CALCULATION )||
        		rt.equals(org.researchedc.bean.core.ResponseType.GROUP_CALCULATION )){
        	return false;
        }
...
//
    ...
    public void mayAccess(HttpServletRequest request) throws InsufficientPermissionException {
        ...
        if (eventCRFId > 0) {
            if (!entityIncluded(eventCRFId, ub.getName(), (AuditableEntityDAO) edao, getDataSource())) {
