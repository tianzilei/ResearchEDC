...
import org.researchedc.bean.extract.TabReportBean;
...
import org.researchedc.web.job.XalanTriggerService;
        ...
        if (StringUtil.isBlank(action)) {
            ...
            if ("sas".equalsIgnoreCase(action)) {
                ...
                if (fp.getString("xalan") != null) {
                    ...
                    jobDetailBean.setJobClass(org.researchedc.web.job.XalanStatefulJob.class);
