...
//        mayAccess();
    ...
    public void processRequest() throws Exception {
        ...
        if (studySubId == 0) {
            ...
            /*
             * IStudyDAO studydao = this.studyDao; StudyBean
    ...
    public static void populateUncompletedCRFsWithCRFAndVersions(DataSource ds, ArrayList uncompletedEventDefinitionCRFs, ICrfDAO cdao, ICrfVersionDAO cvdao) {
     ...
     * eventDefinitionCRFs) { ICrfDAO cdao = this.crfDao;
     * CRFVersionDAO vdao = this.crfVersionDao; HashMap
    ...
    public void mayAccess() throws InsufficientPermissionException {
        ...
        if (studySubId > 0) {
            if (!entityIncluded(studySubId, ub.getName(), (AuditableEntityDAO) subdao, sm.getDataSource())) {
    ...
    private void addDiscrepancyNotesFromChildStudies(List<DiscrepancyNoteBean> discBeans, int parentStudyId, int subjectId, int studySubId, IStudyDAO studyDAO,
