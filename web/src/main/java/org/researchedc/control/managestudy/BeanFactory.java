 ...
 * 
 * @see org.researchedc.control.admin.SpreadsheetPreviewNw
 */
public class BeanFactory {
    public static final String UNGROUPED = "Ungrouped";
    protected static final Logger logger = LoggerFactory.getLogger("org.researchedc.control.managestudy.BeanFactory");
     ...
     * @see org.researchedc.bean.submit.ItemGroupBean
