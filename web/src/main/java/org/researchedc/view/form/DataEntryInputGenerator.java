...
import org.researchedc.i18n.util.HtmlUtils;
...
public class DataEntryInputGenerator implements InputGenerator {
    ...
    private static final Logger logger = LoggerFactory.getLogger("org.researchedc.view.form.DataEntryInputGenerator");
