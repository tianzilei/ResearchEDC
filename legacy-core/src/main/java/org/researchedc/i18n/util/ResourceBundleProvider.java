package org.researchedc.i18n.util;
...
public class ResourceBundleProvider {
    ...
    public static void updateLocale(Locale l) {
        ...
        if (!resBundleSetMap.containsKey(l)) {
            ...
            resBundleSet.put("org.researchedc.i18n.admin", ResourceBundle.getBundle("org.researchedc.i18n.admin", l));
            resBundleSet.put("org.researchedc.i18n.audit_events", ResourceBundle.getBundle("org.researchedc.i18n.audit_events", l));
            resBundleSet.put("org.researchedc.i18n.exceptions", ResourceBundle.getBundle("org.researchedc.i18n.exceptions", l));
            resBundleSet.put("org.researchedc.i18n.format", ResourceBundle.getBundle("org.researchedc.i18n.format", l));
            resBundleSet.put("org.researchedc.i18n.page_messages", ResourceBundle.getBundle("org.researchedc.i18n.page_messages", l));
            resBundleSet.put("org.researchedc.i18n.notes", ResourceBundle.getBundle("org.researchedc.i18n.notes", l));
            resBundleSet.put("org.researchedc.i18n.terms", ResourceBundle.getBundle("org.researchedc.i18n.terms", l));
            resBundleSet.put("org.researchedc.i18n.words", ResourceBundle.getBundle("org.researchedc.i18n.words", l));
            resBundleSet.put("org.researchedc.i18n.workflow", ResourceBundle.getBundle("org.researchedc.i18n.workflow", l));
            resBundleSet.put("org.researchedc.i18n.licensing", ResourceBundle.getBundle("org.researchedc.i18n.licensing", l));
    ...
    public static ResourceBundle getAdminBundle() {
        return getResBundle("org.researchedc.i18n.admin");
    }

    public static ResourceBundle getAdminBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.admin", locale);
    }

    public static ResourceBundle getAuditEventsBundle() {
        return getResBundle("org.researchedc.i18n.audit_events");
    }

    public static ResourceBundle getAuditEventsBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.audit_events", locale);
    }

    public static ResourceBundle getExceptionsBundle() {
        return getResBundle("org.researchedc.i18n.exceptions");
    }

    public static ResourceBundle getExceptionsBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.exceptions", locale);
    }

    public static ResourceBundle getFormatBundle() {
        return getResBundle("org.researchedc.i18n.format");
    }

    public static ResourceBundle getFormatBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.format", locale);
    }

    public static ResourceBundle getPageMessagesBundle() {
        return getResBundle("org.researchedc.i18n.page_messages");
    }

    public static ResourceBundle getPageMessagesBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.page_messages", locale);
    }

    public static ResourceBundle getTermsBundle() {
        return getResBundle("org.researchedc.i18n.terms");
    }

    public static ResourceBundle getTermsBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.terms", locale);
    }

    public static ResourceBundle getWordsBundle() {
        return getResBundle("org.researchedc.i18n.words");
    }

    public static ResourceBundle getWordsBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.words", locale);
    }

    public static ResourceBundle getTextsBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.notes", locale);
    }

    public static ResourceBundle getTextsBundle() {
        return getResBundle("org.researchedc.i18n.notes");
    }

    public static ResourceBundle getWorkflowBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.workflow", locale);
    }

    public static ResourceBundle getLicensingBundle() {
        return getResBundle("org.researchedc.i18n.licensing");
    }

    public static ResourceBundle getLicensingBundle(Locale locale) {
        return getResBundle("org.researchedc.i18n.licensing", locale);
    }
    ...
    public static String getResTerm(String key) {
        String value;
        try {
            value = getResBundle("org.researchedc.i18n.terms").getString(key);
        } catch (MissingResourceException mre) {
            value = key;
        }
        return value;
    ...
    public static String getResWord(String key) {
        String value;
        try {
            value = getResBundle("org.researchedc.i18n.words").getString(key);
        } catch (MissingResourceException mre) {
            value = key;
        }
        return value;
