 ...
 */
package org.researchedc.domain.rule.expression;
...
public class ExpressionBean extends AbstractAuditableMutableDomainObject implements Serializable {
    ...
    @Type(value = org.researchedc.domain.enumsupport.CodedEnumType.class, parameters = @org.hibernate.annotations.Parameter(name = "enumClassname", value = "org.researchedc.bean.rule.expression.Context"))
    @Column(name = "context")
