...
public abstract class AbstractAuditableMutableDomainObject extends AbstractMutableDomainObject implements MutableDomainObject, AuditableMutableDomainObject, Serializable {
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#getCreatedDate()
     */
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#setCreatedDate(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#getUpdatedDate()
     */
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#setUpdatedDate(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#getOwner()
     */
    @Transient
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#setOwner(org.researchedc.bean.login.UserAccountBean)
     */
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#getUpdater()
     */
    @Transient
    ...
    /* (non-Javadoc)
     * @see org.researchedc.domain.AuditableMutableDomainObject#setUpdater(org.researchedc.bean.login.UserAccountBean)
     */
