...
├── shared/                  # 共享领域逻辑与数据访问 — 82 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (43 Java files)
│   ├── domain/              # Hibernate 实体 (35 Java files; duplicate admin/managestudy, technicaladmin/rule, crfdata, DN/subjectgroup map, and unused datamap mappings removed)
