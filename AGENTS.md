...
│   └── module/              # Spring Modulith modules (17 modules, 399 Java files)
...
├── shared/                  # 共享兼容 DTO/term beans — 16 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (16 Java files)
...
| **Shared (legacy) logic** | `shared/src/main/java/org/researchedc/` | Compatibility DTO/term beans; shared DAO/domain/support Java mappings are retired |
