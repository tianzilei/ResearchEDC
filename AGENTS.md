...
├── shared/                  # 共享兼容 DTO/term beans — 15 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (15 Java files)
