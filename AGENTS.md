...
├── shared/                  # 共享兼容 DTO/term beans — 22 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (22 Java files)
