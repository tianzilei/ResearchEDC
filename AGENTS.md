...
├── shared/                  # 共享领域逻辑与数据访问 — 74 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (38 Java files)
│   ├── domain/              # Hibernate 实体 (32 Java files; duplicate admin/managestudy, technicaladmin/rule/crfdata, DN/subjectgroup/discrepancy-note map, and unused datamap mappings removed)
...
| Legacy Hibernate entities | `shared/.../domain/datamap/` | 19 Java files, JPA 注解 |
