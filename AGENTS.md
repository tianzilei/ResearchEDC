...
├── shared/                  # 共享领域逻辑与数据访问 — 114 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (52 Java files)
│   ├── domain/              # Hibernate 实体 (54 Java files; duplicate admin/managestudy, technicaladmin/rule, DN map, and unused datamap mappings removed)
...
| Legacy Hibernate entities | `shared/.../domain/datamap/` | 33 Java files, JPA 注解 |
