...
│   └── module/              # Spring Modulith modules (17 modules, 383 Java files)
...
├── shared/                  # 共享领域逻辑与数据访问 — 89 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (45 Java files)
│   ├── domain/              # Hibernate 实体 (36 Java files; duplicate admin/managestudy, technicaladmin/rule, crfdata, DN/subjectgroup map, and unused datamap mappings removed)
...
| Legacy Hibernate entities | `shared/.../domain/datamap/` | 22 Java files, JPA 注解 |
