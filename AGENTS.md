...
├── shared/                  # 共享兼容 DTO/term beans — 14 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (14 Java files)
