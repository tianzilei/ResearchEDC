...
├── shared/                  # 共享兼容 DTO/term beans — 34 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (34 Java files)
