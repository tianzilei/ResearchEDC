...
├── shared/                  # 共享兼容 DTO/term beans — 26 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (26 Java files)
