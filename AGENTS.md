...
├── shared/                  # 共享领域逻辑与数据访问 — 109 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (52 Java files)
│   ├── domain/              # Hibernate 实体 (49 Java files; duplicate admin/managestudy, technicaladmin/rule, DN/subjectgroup map, and unused datamap mappings removed)
...
| Legacy Hibernate entities | `shared/.../domain/datamap/` | 28 Java files, JPA 注解 |
