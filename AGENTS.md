...
├── shared/                  # 共享兼容 DTO/term beans — 18 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (18 Java files)
