...
├── shared/                  # 共享兼容 DTO/term beans — 20 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (20 Java files)
