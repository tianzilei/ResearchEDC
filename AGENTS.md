...
├── shared/                  # 共享兼容 DTO/term beans — 17 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (17 Java files)
