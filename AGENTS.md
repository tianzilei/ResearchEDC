...
├── shared/                  # 共享领域逻辑与数据访问 — 106 Java files (replaces legacy-core, still legacy-heavy)
│   ├── bean/                # DTOs (52 Java files)
│   ├── domain/              # Hibernate 实体 (46 Java files; duplicate admin/managestudy, technicaladmin/rule, DN/subjectgroup map, and unused datamap mappings removed)
...
| Legacy Hibernate entities | `shared/.../domain/datamap/` | 25 Java files, JPA 注解 |
