...
| Legacy DAOs | `shared/.../dao/` | 73 DAO/SPI/support Java files; deletion blocked by replacement proof |
...
- **Refactor progress snapshot (2026-06-15):** active workflow inventory is 890/963 closed (**92.4%**), Phase 3 DAO method coverage is 878/878 module-backed or removed (**100%**), DAO method blockers are 0/878 unused rows (**0%**), shared/ reduced from 793 to 278 files (**64.9%**), LegacyDaoFactory eliminated, EntityDAO infrastructure deleted, dead code cleanup complete.
