...
- **Gauntlet commands:**
  - `git status --short`
  - `mvn -pl app -am compile -DskipTests && mvn test -pl app -am -Dtest=ModulithVerificationTest,OdmExportGeneratorTest -Dsurefire.failIfNoSpecifiedTests=false`
